...
Cada subcarpeta dentro de `uis/` debe corresponder a **una interfaz de usuario concreta** (por ejemplo `web-portal`, `backoffice-dashboard`) e incluir su propia documentación técnica y funcional.
